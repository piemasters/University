...
public class Cryptography extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Fermat_Label = new javax.swing.JLabel();
        Dixon_Label = new javax.swing.JLabel();
        Fermat_Input = new javax.swing.JTextField();
        Dixon_Input = new javax.swing.JTextField();
        Fermat_Button = new javax.swing.JButton();
        Dixon_Button = new javax.swing.JButton();
        ...
        Message.setText("To use a tool below enter a valid value, then click the matching button to display the result below.");
        ...
        Fermat_Label.setText("Fermat Factorising:");

        Dixon_Label.setText("Dixon Factorising:");

        Fermat_Input.setText("2450609331732137");
        Fermat_Input.setToolTipText("Enter a large integer.");

        Dixon_Input.setText("2450609331732137");
        Dixon_Input.setToolTipText("Enter a large integer.");

        Fermat_Button.setText("Factorise");
        Fermat_Button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Fermat_ButtonMouseClicked(evt);
            }
        });

        Dixon_Button.setText("Factorise");
        Dixon_Button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Dixon_ButtonMouseClicked(evt);
            }
        });
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(Dixon_Label, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(Fermat_Label, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)))
                                .addGap(23, 23, 23)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(Fermat_Input)
                                    ...
                                    .addComponent(SHA1_BF2_Input, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                                    .addComponent(Dixon_Input, javax.swing.GroupLayout.Alignment.TRAILING))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(BCH_Gen_Button1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(Hamming_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addComponent(BCH_Gen_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(BCH_Dec_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(SHA1_Gen_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(SHA1_BF_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(SHA1_BF2_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(Clear_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(Dixon_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(Fermat_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(29, 29, 29))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Fermat_Label)
                    .addComponent(Fermat_Input, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Fermat_Button))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Dixon_Label)
                    .addComponent(Dixon_Input, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Dixon_Button))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 15, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Clear_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        Fermat_Label.getAccessibleContext().setAccessibleName("Fermat Factorising:");
        ...
        if ("Valid".equals(validInput)) {
            ...
            for (int wordLength = 1; wordLength <= MAX_WORD_LENGTH; wordLength++) {
                try {
                    ...
                    if (SHA1_Brute_Force.generate(wordLength, SHA1_Brute_Force.charSet, encodedHash, special)) {
    ...
    private void Fermat_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Fermat_ButtonMouseClicked
        
        // Get user input.
        String input = Fermat_Input.getText();
        
        // Check if input is valid
        String validInput = SharedMethods.getVariableLengthNumber(input);

        if ("Valid".equals(validInput)) {
            
            // Get integer value of user input.
            long n = Long.parseLong(Fermat_Input.getText());
            
            // Start timer.
            long startTime = System.nanoTime();
        
            // Get both roots.
            long r1 = Fermat.calcR1(n);
            long r2 = Fermat.calcR2(n, r1);
    ...
    }//GEN-LAST:event_Fermat_ButtonMouseClicked

    private void Dixon_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Dixon_ButtonMouseClicked
        
        // Get user input.
        String input = Dixon_Input.getText();
        ...
        if ("Valid".equals(validInput)) {
            ...
            // Get integer value of user input.
            long n = Long.parseLong(Dixon_Input.getText());
        
            // Start timer.
            long startTime = System.nanoTime();
            
            // Display roots
            String answer = Dixon.dixon(n);
    ...
    }//GEN-LAST:event_Dixon_ButtonMouseClicked
    ...
    private javax.swing.JButton Dixon_Button;
    private javax.swing.JTextField Dixon_Input;
    private javax.swing.JLabel Dixon_Label;
    private javax.swing.JButton Fermat_Button;
    private javax.swing.JTextField Fermat_Input;
    private javax.swing.JLabel Fermat_Label;
