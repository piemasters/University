	...
	<section id="content">
		...
		<aside> 
			<img src="<?=$row['Image_Location'];?>" alt="Shinedown">
				...
				<form action="/scripts/favShinedown.php">
					<input type="image" id ="fav" src="images/star.png" alt="Submit" width="25" height="25">
				</form>
		...
		<aside> 
			<h2>Fans</h2>
			<?php $echo = mysql_query("SELECT * FROM artistfavorited WHERE Artist_ID = 1");
					  require 'scripts/fans.php';?>
		</aside>
