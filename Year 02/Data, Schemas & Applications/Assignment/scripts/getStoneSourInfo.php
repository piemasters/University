...
$artistQuery = mysql_query("SELECT * FROM artist WHERE Artist_Name ='Stone Sour'");
$row = mysql_fetch_array($artistQuery);

$data1 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 54"));
$data2 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 55"));
$data3 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 56"));
$data4 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 57"));
$data5 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 58"));
