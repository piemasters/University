...
$artistQuery = mysql_query("SELECT * FROM artist WHERE Artist_Name ='Apocalyptica'");
$row = mysql_fetch_array($artistQuery);

$data1 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 65"));
$data2 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 66"));
$data3 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 67"));
$data4 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 68"));
$data5 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 69"));
