...
$artistQuery = mysql_query("SELECT * FROM artist WHERE Artist_Name ='Slash'");
$row = mysql_fetch_array($artistQuery);

$data1 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 88"));
$data2 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 89"));
$data3 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 90"));
$data4 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 91"));
$data5 = mysql_fetch_array(mysql_query("SELECT * FROM `song` WHERE Song_ID = 92"));
