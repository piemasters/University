...
<head>
  <meta charset="utf-8">
  <title>BFS Music - Stone Sour</title>
  <meta name="description" content="Stone Sour">
...
<body>  
	...
	<?php require 'scripts/getStoneSourInfo.php';?>
	...
	<section id="content">
		...
		<aside> 
			<img src="<?=$row['Image_Location'];?>" alt="Stone Sour">
