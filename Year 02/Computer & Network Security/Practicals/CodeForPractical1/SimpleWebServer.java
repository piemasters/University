...
public class SimpleWebServer {                            
    ...
    public void processRequest(Socket s) throws Exception { 
 	...
 	encPathname = st.nextToken();   
      System.out.println("Pathname = " + encPathname);   
  
      /* Deal with RFC 2396 encoding */      
      String pathname = decPathName(encPathname);
      System.out.println ("Path is now " + pathname);                                       
    ...
    public String decPathName(String encodedName){
        String path = null;
        try {
           path = URLDecoder.decode(encodedName, "UTF-8");
