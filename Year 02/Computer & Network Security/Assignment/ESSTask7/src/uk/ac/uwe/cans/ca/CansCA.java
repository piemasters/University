...
public class CansCA {
    ...
    public final String keystoreName = "CA.ks";
    public final String keystorePath = "src/Files/" + keystoreName;
    public final String keyAlias = "CA";
    ...
    public void listen() {
        ...
        try {
            serverSocket = new ServerSocket(CA_SSL_PORT);
            System.out.println("CA listening on port " + CA_SSL_PORT);
        } catch (IOException se) {
            System.err.println("CA cannot listen on port " + CA_SSL_PORT);
            System.exit(-1);
        }
