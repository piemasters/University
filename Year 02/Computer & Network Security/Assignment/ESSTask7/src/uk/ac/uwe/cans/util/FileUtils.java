...
public class FileUtils {
    ...
    public static void storeCertificate(X509Certificate cert, String path) throws FileNotFoundException, CertificateEncodingException, IOException {
        
        FileOutputStream fos = new FileOutputStream(path);
        byte[] save = cert.getEncoded();
        fos.write(save);
    }
}
