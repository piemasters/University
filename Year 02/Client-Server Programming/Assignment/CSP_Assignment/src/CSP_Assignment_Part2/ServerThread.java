...
public class ServerThread extends Thread {
    ...
    //===========================| Set up variables |===========================
    protected Socket mySocket = null, fileSocket = null;
    ...
    public ServerThread(Socket socket, Socket fSocket, 
            CounterProtocol systemLog) {
        this.mySocket = socket;
        this.fileSocket = fSocket;
    ...
    public void run() {
        ...
        try {
            ...
            serverOutput = serverProtocol.runProtocol
                    (clientOutput, mySocket, fileSocket);
