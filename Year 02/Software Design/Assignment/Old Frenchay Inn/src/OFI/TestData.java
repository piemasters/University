...
public class TestData extends Interface {

    public static RoomType[] RoomTypeData() {
    ...
    public static Room[] RoomData(RoomType[] roomTypeList) {
    ...
    public static Booking[] BookingData() {
